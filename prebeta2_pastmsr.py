# -*- coding: utf-8 -*-
"""
Created on Thu Oct 18 10:59:13 2018
...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 17 13:18:05 2018
...
fin = ['KB금융', '신한지주', '하나금융지주', '세아제강지주', '우리은행', '기업은행', '미래에셋대우', '한국금융지주', 'NH투자증권', '삼성증권', 'BNK금융지주', '메리츠종금증권', '키움증권', 'DGB금융지주', '메리츠금융지주', 'JB금융지주', '유안타증권', '대신증권', '한국자산신탁', '광주은행', '우리종금', '신영증권', '한화투자증권', 'SK증권', '현대차증권', '유진투자증권', 'KTB투자증권', '부국증권', 'DB금융투자', '유화증권', '골든브릿지증권', '제주은행', '한양증권']
...
data_prebeta = pd.ExcelFile('C:\\Users\\장연숙\\Documents\\Paper2\\prebeta2.xlsx')
data_mispmsr = pd.ExcelFile('C:\\Users\\장연숙\\Documents\\Paper2\\misp_msr2.xlsx')
prebeta = pd.read_excel(data_prebeta, 'beta_shrink') #from 2003 to 2017
