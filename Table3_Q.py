# -*- coding: utf-8 -*-
"""
Created on Tue Oct 23 21:03:20 2018
...
for t in range(len(prebetan)):
    overp = [item for sublist in misp_msrn.iloc[t:t+1, quin*4:].values.tolist() for item in sublist]
    high_vol = [item for sublist in ivol_n.iloc[t:t+1, quin*4:].values.tolist() for item in sublist]
