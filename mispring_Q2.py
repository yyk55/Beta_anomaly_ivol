...
count = cnt_ItoA + cnt_ROA + cnt_AG + cnt_GPP + cnt_MOM + cnt_STR

# calculation of total mispricing measure
sum_misp = fna_ItoA + fna_ROA + fna_AG + fna_GPP + fna_MOM + fna_STR
misp_msr = (sum_misp / count).dropna(axis=1)

writer6 = pd.ExcelWriter('C:\\Users\\장연숙\\Documents\\Paper2\\mispring_Q2.xlsx')
